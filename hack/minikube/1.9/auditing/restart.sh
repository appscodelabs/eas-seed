...
cp ~/go/src/github.com/etcd-manager/etcd-discovery/minikube/1.9/auditing/kube-apiserver.yaml ~/.minikube/files/kube-apiserver.yaml
cp ~/go/src/github.com/etcd-manager/etcd-discovery/minikube/1.9/auditing/audit-policy.yaml ~/.minikube/files/audit-policy.yaml
cp ~/go/src/github.com/etcd-manager/etcd-discovery/minikube/1.9/auditing/hit-config.yaml ~/.minikube/files/hit-config.yaml
