...
show_help() {
    echo "etcd-discovery.sh - install pharmer apiserver"
    echo " "
    ...
    echo "    --docker-registry              docker registry used to pull voyager images (default: pharmer)"
    ...
    echo "    --uninstall                    uninstall pharmer apiserver"
}
