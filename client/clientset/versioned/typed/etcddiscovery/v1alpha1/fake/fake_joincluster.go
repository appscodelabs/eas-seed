...
type FakeJoinClusters struct {
	Fake *FakeEtcddiscoveryV1alpha1
}

var joinclustersResource = schema.GroupVersionResource{Group: "etcddiscovery.pharmer.com", Version: "v1alpha1", Resource: "joinclusters"}

var joinclustersKind = schema.GroupVersionKind{Group: "etcddiscovery.pharmer.com", Version: "v1alpha1", Kind: "JoinCluster"}
