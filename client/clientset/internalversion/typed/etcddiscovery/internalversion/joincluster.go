...
type JoinClusterInterface interface {
	Create(*etcddiscovery.JoinCluster) (*etcddiscovery.JoinCluster, error)
...
func newJoinClusters(c *EtcddiscoveryClient) *joinClusters {
	return &joinClusters{
		client: c.RESTClient(),
	}
}
...
func (c *joinClusters) Create(joinCluster *etcddiscovery.JoinCluster) (result *etcddiscovery.JoinCluster, err error) {
	result = &etcddiscovery.JoinCluster{}
	err = c.client.Post().
